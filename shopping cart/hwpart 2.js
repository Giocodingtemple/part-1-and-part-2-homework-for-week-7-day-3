...
Giovanni.enterStore()
let eggs = Giovanni.makeItem('eggs',5,"dozen eggs")
let lettuce = Giovanni.makeItem('lettuce',2,"Crispy Head of Lettuce")
let tomato = Giovanni.makeItem('tomato',3,"juicy")
let bacon = Giovanni.makeItem('bacon',10,"sizzling")
Giovanni.shoppingCart('add',eggs)
Giovanni.shoppingCart('add',lettuce)
Giovanni.shoppingCart('add',tomato)
Giovanni.shoppingCart('add',bacon)
Giovanni.shoppingCart('empty','')
Giovanni.shoppingCart('add',tomato)
Giovanni.shoppingCart('add',bacon)
Giovanni.shoppingCart('show','')
Giovanni.shoppingCart('remove',tomato)
